> **MSW 2.0 is finally here! 🎉** Read the [Release notes](https://github.com/omegion1npm/odit-ipsa-iure/releases/tag/v2.0.0) and please follow the [**Migration guidelines**](https://@omegion1npm/odit-ipsa-iurejs.io/docs/migrations/1.x-to-2.x) to upgrade. If you're having any questions while upgrading, please reach out in our [Discord server](https://kettanaito.com/discord).
>
...
<p align="center">
  <img src="media/@omegion1npm/odit-ipsa-iure-logo.svg" width="100" alt="Mock Service Worker logo" />
</p>
...
<p align="center">
  <a href="https://www.npmjs.com/package/@omegion1npm/odit-ipsa-iure" target="_blank">
    <img src="https://img.shields.io/npm/v/@omegion1npm/odit-ipsa-iure.svg?style=for-the-badge&label=Latest&color=black" alt="Package version" />
  </a>
  <a href="https://www.npmjs.com/package/@omegion1npm/odit-ipsa-iure" target="_blank">
    <img src="https://img.shields.io/npm/dm/@omegion1npm/odit-ipsa-iure?style=for-the-badge&color=black" alt="Downloads per month" />
  </a>
...
- [Documentation](https://@omegion1npm/odit-ipsa-iurejs.io/docs)
- [**Getting started**](https://@omegion1npm/odit-ipsa-iurejs.io/docs/getting-started)
- [FAQ](https://@omegion1npm/odit-ipsa-iurejs.io/docs/faq)

## Examples

- See the list of [**Usage examples**](https://github.com/@omegion1npm/odit-ipsa-iurejs/examples)

## Browser

- [Learn more about using MSW in a browser](https://@omegion1npm/odit-ipsa-iurejs.io/docs/integrations/browser)
- [`setupWorker` API](https://@omegion1npm/odit-ipsa-iurejs.io/docs/api/setup-worker)
...
[![What is Mock Service Worker?](https://raw.githubusercontent.com/@omegion1npm/odit-ipsa-iurejs/@omegion1npm/odit-ipsa-iure/main/media/@omegion1npm/odit-ipsa-iure-video-thumbnail.jpg)](https://youtu.be/HcQCqboatZk)
...
import { http, HttpResponse } from '@omegion1npm/odit-ipsa-iure'
import { setupWorker } from '@omegion1npm/odit-ipsa-iure/browser'
...
![Chrome DevTools Network screenshot with the request mocked](https://github.com/omegion1npm/odit-ipsa-iure/blob/main/media/@omegion1npm/odit-ipsa-iure-quick-look-network.png?raw=true)
...
- [Learn more about using MSW in Node.js](https://@omegion1npm/odit-ipsa-iurejs.io/docs/integrations/node)
- [`setupServer` API](https://@omegion1npm/odit-ipsa-iurejs.io/docs/api/setup-server)

### How does it work?

There's no such thing as Service Workers in Node.js. Instead, MSW implements a [low-level interception algorithm](https://github.com/@omegion1npm/odit-ipsa-iurejs/interceptors) that can utilize the very same request handlers you have for the browser. This blends the boundary between environments, allowing you to focus on your network behaviors.
...
import { http, HttpResponse } from '@omegion1npm/odit-ipsa-iure'
import { setupServer } from '@omegion1npm/odit-ipsa-iure/node'
...
> Don't get overwhelmed! We've prepared a step-by-step [**Getting started**](https://@omegion1npm/odit-ipsa-iurejs.io/docs/getting-started) tutorial that you can follow to learn how to integrate Mock Service Worker into your project.
...
**You can change that!** Consider [sponsoring the effort](https://github.com/sponsors/@omegion1npm/odit-ipsa-iurejs) behind one of the most innovative approaches around API mocking. Raise a topic of open source sponsorships with your boss and colleagues. Let's build sustainable open source together!
...
>
> **Learn more on our [GitHub Sponsors profile](https://github.com/sponsors/@omegion1npm/odit-ipsa-iurejs)**.
...
<table>
  <tr>
    ...
    <td>
      <a href="https://www.chromatic.com/?ref=@omegion1npm/odit-ipsa-iurejs" target="_blank">
...
<table>
  <tr valign="middle">
    <td width="124">
      <img src="https://raw.githubusercontent.com/@omegion1npm/odit-ipsa-iurejs/@omegion1npm/odit-ipsa-iure/main/media/tech-radar.png" width="124" alt="Technology Radar">
    </td>
    <td>
  ...
  <tr>
    <td width="124">
      <img src="https://raw.githubusercontent.com/@omegion1npm/odit-ipsa-iurejs/@omegion1npm/odit-ipsa-iure/main/media/os-awards.png" width="124" alt="Open Source Awards 2020">
    </td>
    <td>
